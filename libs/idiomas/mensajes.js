...
1️⃣ Abre el menú ⋮ en la esquina superior derecha.\n
2️⃣ Selecciona *WhatsApp Web* ⑆\n
3️⃣ Escanea el código QR ⌁\n\n
⚠️ *El QR expira en 45 segundos. Conéctate rápido.* 〄\n\n`,

  text2: `
*╔═════════════╗*
_〚 ⃟ᴊᴀᴅɪʙᴏᴛ ᴍɪᴄᴀsʜᴀᴅᴇ_
*╚═════════════╝*

⟣ ɴᴜᴇᴠᴀ ᴏᴘᴄɪᴏ́ɴ ᴇɴ ᴍɪᴄᴀsʜᴀᴅᴇ ⟢

sᴜʙ-ʙᴏᴛ ᴇsᴛᴀ́ ᴇɴ ᴅᴇsᴀʀʀᴏʟʟᴏ ᴘᴀʀᴀ ǫᴜᴇ ᴇsᴛᴇ́ 24/7.
ʟᴀ ᴅᴜʀᴀᴄɪᴏ́ɴ ᴘᴜᴇᴅᴇ ᴠᴀʀɪᴀʀ ᴅᴇʙɪᴅᴏ ᴀ ᴍᴀɴᴛᴇɴɪᴍɪᴇɴᴛᴏs.

⟡ ᴄᴏɴᴇ́ᴄᴛᴀᴛᴇ ᴄᴏɴ ᴇʟ sɪɢᴜɪᴇɴᴛᴇ ᴄᴏ́ᴅɪɢᴏ:\n`,

  text3: `⚠ *Este comando ha sido deshabilitado por el administrador.*`,
  text4: `✔ *Conexión en curso... Espera mientras se cargan los mensajes.*`,
  text5: `✔ *Conexión establecida correctamente.*`,
  text6: `⊹ Bot:`,
  text7: `⊹ Administrador:`,
  text8: `✦ *Nota:* La conexión es temporal. Si el bot principal se reinicia o se desactiva, todos los Sub Bots también lo harán.\n\nSi el bot deja de funcionar, intenta conectarte de nuevo con el siguiente comando...`,
  text9: `⚠ *Dispositivo desconectado. Deberás volver a conectarte con #jadibot.*`,
  text10: `⚠ *Reenvía el comando...*`,
  text11: `⚠ *Reinicio requerido. Procesando...*`,
  text12: `⚠ *Dispositivo desconectado.*\n\n*Tendrás que iniciar sesión nuevamente (usa .deljadibot)*`,
  text13: `⚠ *Conexión cerrada.*\n*Intenta reconectarte con:*`,
  text14: `⚠ *Conexión perdida con el servidor. Reconexión en curso...*`,
  text15: `⚠ *Tu conexión es inválida.*\n*No se podrá restablecer.*`,
  text16: `⚠ *Se agotó el tiempo de conexión.*`,
  text17: `⚠ *Error desconocido:*`,
  text18: `✦ *Sub Bots Conectados:*`
};
